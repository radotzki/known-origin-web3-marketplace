...
module.exports = async function (deployer, network, accounts) {
  ...
  await auction.setArtistsAddressAndEnabledEdition(18500, aktivProtesk);
  await auction.setArtistsAddressAndEnabledEdition(18600, aktivProtesk);
  await auction.setArtistsAddressAndEnabledEdition(18700, aktivProtesk);
  await auction.setArtistsAddressAndEnabledEdition(18800, aktivProtesk);
};
