...
// Self Service //
//////////////////
export const SET_SELF_SERVICE_CONTROLS = 'SET_SELF_SERVICE_CONTROLS';
export const SELF_SERVICE_RESET = 'SELF_SERVICE_RESET';
export const SELF_SERVICE_TRIGGERED = 'SELF_SERVICE_TRIGGERED';
export const SELF_SERVICE_STARTED = 'SELF_SERVICE_STARTED';
export const SELF_SERVICE_FAILED = 'SELF_SERVICE_FAILED';
export const SELF_SERVICE_SUCCESSFUL = 'SELF_SERVICE_SUCCESSFUL';
